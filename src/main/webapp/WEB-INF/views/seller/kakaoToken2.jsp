...
function kakaoLogin2(){
	   ...
	   xhr.send("grant_type=authorization_code&client_id=9c133e8e0ca99f4e08b962a90d53f8a4&redirect_uri=http://localhost:8181/roaming/seller/kakaoToken2&code="+'${code}')
	}
