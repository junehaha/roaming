                ...
                <div class="row">
                    ...
                    <div class="col-10">
                        <div class="row mt-5">
                            ...
                            <div class="col-8">
                                <div class="row mt-5">
                                    <div class="col  mb-3 fw-semibold fs-4 text-center">
										<img src="../resources/img/kakaoMini.jpg" style="height: 30px; width: 30px;" class="mb-2"> 카카오로 간편 회원가입
									</div>
                                </div>
                                 <div class="row mt-2">
                                	<div class="col text-center">
<img src="../resources/img/originalLogo.png" style="height: 50px; width: 160px;">                                	</div>
                                 </div>
                                ...
                                <form action="./kakaoSellerRegisterProcess" method="post" id="frm">
                                <div class="row mt-2">
                                    <div class="col"></div>
                                    <div class="col-10">
										<span class="small fw-semibold">전화번호 *</span>
                                        <input type="text" name="phone" class="form-control  mt-2" placeholder="전화번호" id="phone">
                                    </div>
                                    <div class="col"></div>
                                </div>
                                <div class="row mt-2">
                                ...
                                <div class="row">
                                    <div class="col"></div>
                                    <div class="col-10">
                                        <input type="button" class="btn btn-dark btn-lg btn-block mt-3 w-100" style="border-radius: 5px;" value="파트너 가입" onclick="selectNullPoint()">
                                    </div>
                                    <div class="col"></div>
                                </div>
                                </form>
