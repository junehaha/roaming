      ...
      <div class="row">
         ...
         <div class="col px-5">
			<div class="row mt-5 px-4">
				<div class="col">
					<h3><i class="bi bi-question-circle"></i> 자주묻는 질문</h3>					
				</div>
			</div>
			...
			<div class="row mt-4 px-4">
				<div class="row">
					<table class="table table-bordered">
						<tr>
							...
							<td class="bg-light">${faqDto.id }</td>
						</tr>
						<tr>
							<td class="table-active text-center">작성일</td>
							<td class="bg-light">
							<fmt:formatDate value="${faqDto.reg_date}" pattern="yyyy-MM-dd HH:mm"/>
							</td>
						</tr>
						<tr>
							<td class="table-active text-center">제목</td>
							<td class="bg-light">${faqDto.faq_title }</td>
						</tr>
						<tr>
							<td  class="table-active text-center" style="height : 120px; width : 150px; vertical-align: middle">
								내용
							</td>
							<td class="bg-light" style="height : 120px; width : 450px;">
								<c:if test="${faqDto.faq_content != null}">
									${faqDto.faq_content }
								</c:if>
							</td>
						</tr>
				...
				<div class="row d-flex flex-row-reverse">
					<div class="col-1">
						<a class="btn btn-danger btn-sm form-control" href="./adminDeleteFaqProcess?id=${faqDto.id }" role="button">삭제</a>	
					</div>
					<div class="col-1">
							<a class="btn btn-secondary btn-sm form-control" href="../admincsboard/adminFaqPage" role="button">목록</a>
					</div>
				</div>
			</div>
