      ...
      <div class="row">
            ...
            <div class="row mt-4">
               ...
               <div class="col  pb-0">
                  <a href="../admincsboard/adminFaqPage" style="text-decoration: none; color: inherit;">
                     ...
                     <span class="ps-3 text-primary adminSideNavText pt-0">자주묻는 질문</span>
                    </a>
               </div>
            </div>
            <div class="row mt-4">
         ...
         <div class="col px-5">
            <div class="row mt-5 px-4">
                <div class="col">
                    <h3><i class="bi bi-question-circle me-2"></i> 자주묻는 질문 등록</h3>					
                </div>
            </div>
                                ...
                                <li class="list-group-item">
                                    <div class="row text-center">
                                        <div class="col-1 fw-semibold">
                                            <div class="col">${list.faqDto.id }</div>
                                        </div>
                                        <div class="col-2">
                                            <div class="row">
                                                <div class="col">
                                                        ${list.faqCategoryDto.faq_name}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-5 text-start text-truncate">
                                            <div class="row">
                                                <div class="col">
                                                    <a class="link-dark link-offset-2 link-underline link-underline-opacity-0 link-opacity-25-hover" href="./adminReadFaqPage?id=${list.faqDto.id}">
                                                        <div class="d-inline-block text-truncate" style="max-width: 100%">
                                                            ${list.faqDto.faq_title}
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-2">
                                            <div class="row">
                                                <div class="col">${list.adminDto.admin_id}</div>
                                            </div>
                                        </div>
                                        <div class="col-2">
                                            <div class="row">
                                                <div class="col"><fmt:formatDate value="${list.faqDto.reg_date}" pattern="yyyy-MM-dd"/></div>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                ...
                <div class="col-2">
                    <div>
                        <c:if test="${!empty sessionAdmin}">
                            <a href="../admincsboard/adminWriteFaqPage" class="btn btn-dark form-control" role="button">글쓰기</a>
                        </c:if>
                    </div>
                </div>
            </div>
