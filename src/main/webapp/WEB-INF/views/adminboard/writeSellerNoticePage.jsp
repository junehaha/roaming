...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-8 bg-secondary bg-opacity-10 info-scroll-container">
			...
			<form action="./writeSellerNoticeProcess" method="post">
				...
				<div class="col">
					...
					<div class="row border-secondary-subtle border-top border-1">
						...
						<div class="col-10 px-3 py-2 bg-light d-flex">
							<input type="text" class="form-control flex-grow-1" placeholder="제목을 입력하세요" id="title" name="title">
						</div>
					</div>
					<div class="row border-secondary-subtle border-top border-bottom border-1">
						...
						<div class="col-10 px-3 py-2 bg-light d-flex">
							<textarea class="textbox form-control flex-grow-1" placeholder="내용을 입력하세요" id="content" name="content"></textarea>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row mt-4 px-4">
				...
				<div class="col-2 text-center">
					<button class="btn btn-secondary form-control">작성</button>
				</div>
				<div class="col-2 text-center">
					<a class="btn btn-secondary form-control" href="./sellerNoticePage" role="button">취소</a>
				</div>
