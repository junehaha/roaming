      ...
      <div class="row">
            ...
            <div class="row mt-4">
               ...
               <div class="col  pb-0">
                <a href="./sellerNoticePage" style="text-decoration: none; color: inherit;">
                  ...
                  <span class="ps-3 text-gray-soft adminSideNavText pt-0 text-primary">공지사항</span>
                </a>
               </div>
            </div>
             <div class="row mt-4">
         ...
         <div class="row mt-5 px-4">
				<div class="col fw-semibold fs-3">
					<i class="bi bi-clipboard me-2"></i>판매자 공지 관리	
				</div>
         </div>
                     ...
                     <li class="list-group-item">
                        <div class="row text-center">
                           <div class="col-1 fw-semibold">
                              <div class="row"><div class="col">${map.sellerNoticeBoardDto.id}</div></div>
                           </div>
                           <div class="col-6 px-3">
                              <div class="row">
                                 <div class="col text-start">
                                    <a class="link-dark link-offset-2 link-underline link-underline-opacity-0 link-opacity-25-hover" href="./readSellerNoticePage?id=${map.sellerNoticeBoardDto.id }">
                                       ${map.sellerNoticeBoardDto.title}
                                    </a>
                                 </div>
                              </div>
                           </div>
                           <div class="col-2">
                              <div class="row">
                                 <div class="col">${map.adminDto.admin_id}</div>
                              </div>
                           </div>
                           <div class="col-2">
                              <div class="row">
                                 <div class="col"><fmt:formatDate value="${map.sellerNoticeBoardDto.reg_date}" pattern="yyyy-MM-dd"/></div>
                              </div>
                           </div>
                           <div class="col-1">
                              <div class="row">
                                 <div class="col">${map.sellerNoticeBoardDto.readCount}</div>
                              </div>
                           </div>
                        </div>
                     </li>
            ...
            <div class="col-2">
               <div>
                  <c:if test="${!empty sessionAdmin}">
                     <a href="./writeSellerNoticePage" class="btn btn-outline-dark form-control" role="button">글쓰기</a>
                  </c:if>
               </div>
            </div>
         </div>
